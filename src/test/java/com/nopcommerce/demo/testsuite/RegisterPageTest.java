...
public class RegisterPageTest extends TestBase {
    ...
    public void verifyThatUserShouldCreateAccountSuccessfully() {
        ...
        // Enter firstname
        registerPage.enterFirstName("Mickey");
        // Enter lastname
        registerPage.enterLastName("patel");
        // Select day
        registerPage.selectDateOfBirth("25");
        // Select month
        registerPage.selectMonthOfBirth("May");
        // Select year
        registerPage.selectYearOfBirth("1992");
        // Enter email
        registerPage.enterEmailId();
        // Enter password
        registerPage.enterPassword("mickey123");
        // Enter Confirm Password
        registerPage.enterConfirmedPassword("mickey123");
        // Click on "REGISTER" button
        registerPage.clickOnRegisterButton();
